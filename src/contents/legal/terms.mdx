...
Subject to these Terms of Service (this "Agreement"), [zewdlabs.co](/)
("OpenStatus", "we", "us" and/or "our") provides access to Zewdlabs's cloud
...
By signing up and using the services provided by Zewdlabs (referred to as the
"Service"), you are agreeing to be bound by the following terms and conditions
("Terms of Service"). The Service is owned and operated by Zewdlabs ("Us",
"We", or "Our").

## 2. Description of Service

Zewdlabs provides an open source monitoring and status page tool. ("the
Product"). The Product is accessible at zewdlabs.co and other domains and
...
directed to our support team at [Context: "support@zewdlabs.co"].
...
By using Zewdlabs , you acknowledge that you have read these Terms of Service,
