export default function Home() {
  return (
    <div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className=" flex min-h-svh flex-col items-stretch justify-end gap-16 pb-12">
            <div className="flex flex-col items-start gap-8">
              <h1 className="max-w-5xl font-cal font-medium text-4xl text-light-foreground md:text-8xl">
      ...
      <section className="px-5 md:px-10">
        <div className="mx-auto max-w-7xl">
          <h2 className="max-w-5xl font-cal font-medium text-4xl text-light-foreground md:text-8xl">
