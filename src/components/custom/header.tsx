...
export default function Header() {
  return (
    <header className="fixed z-50 flex h-16 w-full items-center justify-center px-5 py-4 backdrop-blur-xl md:h-20 md:px-12">
      <div className="flex w-full max-w-7xl justify-between gap-8">
        ...
        <nav className="hidden w-full items-center justify-between md:flex">
          {/* Links */}
          <ul className="flex font-cal text-accent-foreground text-lg">
            <li>
              <Link
                href="services"
                className="px-4 py-1 transition-colors duration-300 hover:text-accent-foreground/80"
              >
                Services
              </Link>
            </li>
          ...
          <div>
            <HoverBorderGradient className="bg-accent" duration={0.65}>
              <Link
                href="/contact-us"
                className="group inline-flex items-center justify-center gap-4 rounded-full font-cal font-medium transition-colors"
              >
                Contact Us
              </Link>
            </HoverBorderGradient>
